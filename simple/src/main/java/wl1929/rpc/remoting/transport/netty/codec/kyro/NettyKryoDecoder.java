package wl1929.rpc.remoting.transport.netty.codec.kyro;
...
import wl1929.rpc.serialize.Serializer;
...
public class NettyKryoDecoder extends ByteToMessageDecoder {
    ...
    /**
     * Netty传输的消息长度也就是对象序列化后对应的字节数组的大小，
     * 存储在 ByteBuf 头部
     */
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) {
        ...
        if (in.readableBytes() >= BODY_LENGTH) {
            ...
            in.markReaderIndex();
            // 3.读取消息的长度
            // 注意：消息长度是encode的时候我们自己写入的，参见 NettyKryoEncoder的encode方法
